...
def calculate_age():
    ...
    try:
        ...
        # Converte a string da data para um objeto date no formato DD-MM-AAAA
        birthdate = datetime.strptime(birthdate_str, "%d-%m-%Y").date()

        # Chama as funções de cálculo
        chronological_age = calculate_chronological_age(birthdate)
        corrected_age = calculate_corrected_age(
        ...
        result_var.set(
            "Por favor, preencha todos os campos corretamente. Use o formato DD-MM-AAAA para a data."
        )
...
title_label = Label(
    main_frame, text="Calculadora de Idade do Bebê", font=("Verdana", 16, "bold")
)
title_label.pack(pady=10)

# Campo Data de Nascimento
birthdate_label = Label(
    main_frame, text="Data de Nascimento (DD-MM-AAAA):", font=("Verdana", 10)
)
...
gestational_age_label = Label(
    main_frame, text="Idade Gestacional (semanas):", font=("Verdana", 10)
)
...
gestational_age_days_label = Label(
    main_frame, text="Dias na Semana de Nascimento:", font=("Verdana", 10)
)
